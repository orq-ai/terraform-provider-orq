...
const file_google_api_http_proto_rawDesc = "" +
	...
	"\x04path\x18\x02 \x01(\tR\x04pathB\xa6\x01\n" +
	"\x0ecom.google.apiB\tHttpProtoP\x01Z@github.com/orq-ai/terraform-provider-orq/internal/gen/google/api\xa2\x02\x03GAX\xaa\x02\n" +
	"Google.Api\xca\x02\n" +
